...
public class LoginPanel extends javax.swing.JPanel {
   ...
   static LoginPanel cmp = new LoginPanel(); 
    ...
    public LoginPanel() {
       ...
       }else if(UserSignup.password.equals("Password") ||  txtPass1.getText().equals("Password")){
 txtPass1.setEchoChar((char)0);
       }else if("Repeat Password".equals(UserSignup.password) || "Repeat Password".equals(txtPass4.getText())){ 
...
public void updateSystemID(){
    ...
    public static void SignupDefaultValues() {
        ...
        lblImage.setIcon(new javax.swing.ImageIcon(LoginPanel.class.getResource(us.image)));
    }
    ...
    public void pressLogin(){
        ...
        }else if(txtPass.getText().equals("Password") || txtPass.getText().equals("")){
    ...
    private void initComponents() {
        ...
        txtPass1.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                txtPass1PropertyChange(evt);
            }
        });
        ...
        txtPass4.setText("Repeat Password");
        ...
        txtPass4.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                txtPass4PropertyChange(evt);
            }
        });
...
f.ClassDisconnected.flag = false;
 ...
 txtPass1.setFont(new java.awt.Font("Segoe UI", 0, 12));
}    
   ...
   txtPass1.setText("Password");
   txtPass1.setEchoChar((char)0);
    txtPass1.setFont(new java.awt.Font("Segoe UI", 0, 14));
    }       
 ...
 txtPass1.setFont(new java.awt.Font("Segoe UI", 0, 12));
    ...
    private void txtPass2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPass2FocusGained
        if (txtPass2.getText().equals("Password")) {
            txtPass2.setText("");
        }
    ...
    private void txtPass3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtPass3FocusGained
        if (txtPass3.getText().equals("Password")) {
            txtPass3.setText("");
        }
...
LookAndFeel old = UIManager.getLookAndFeel();
        ...
        if (txtContactNumber.getText().equals("Contact Number")) {
            ...
            txtUsername.requestFocus();
        } else if (txtPass1.getText().equals("Password")) {

            JOptionPane.showMessageDialog(null, "Enter your password...");

            txtPass1.requestFocus();
        } else if (txtPass4.getText().equals("Password")) {
...
f.ClassDisconnected.flag = false;
        ...
        LoginPanel.firstOpen = false;
        if (txtFname.getText().equals("Firstname")) {

            JOptionPane.showMessageDialog(null, "Firstname is required...");

            txtFname.requestFocus();
        } else if (txtFname.getText().contains("'")) { 
            JOptionPane.showMessageDialog(null, "Firstname is invalid..."); 
            txtFname.requestFocus();
        } else if (txtMname.getText().contains("'")) { 
            JOptionPane.showMessageDialog(null, "Middlename is invalid..."); 
        ...
        } else if (txtLname.getText().contains("'")) { 
            JOptionPane.showMessageDialog(null, "Lastname is invalid..."); 
            txtLname.requestFocus();
        }else if (txtSuffix.getText().contains("'")) { 
            JOptionPane.showMessageDialog(null, "Suffix is invalid..."); 
            txtSuffix.requestFocus();
        } else {
            
              if (txtPass4.getText().equals("Repeat Password")) {
            txtPass4.setEchoChar((char)0); 
                } else {
   ...
   txtPass4.setText(""); 
   txtPass4.setEchoChar('*');
 txtPass4.setFont(new java.awt.Font("Segoe UI", 0, 12));
    }
   ...
   txtPass4.setText("Repeat Password");
   txtPass4.setEchoChar((char)0);
    txtPass4.setFont(new java.awt.Font("Segoe UI", 0, 14));
    }                 // TODO add your handling code here:
 ...
 txtPass4.setFont(new java.awt.Font("Segoe UI", 0, 12));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (txtPass3.getText().equals("Password") || txtPass3.getText().equals("")) {
        ...
        } else if (txtPass2.getText().equals("Password") || txtPass2.getText().equals("")) {
 ...
 btn_login.requestFocus();
    ...
    private void txtPass1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_txtPass1PropertyChange
if(UserSignup.password.equals("Password") ||  txtPass1.getText().equals("Password")){
 txtPass1.setEchoChar((char)0);
       } else{
            txtPass1.setEchoChar('*'); 
       }
    }//GEN-LAST:event_txtPass1PropertyChange

    private void txtPass4PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_txtPass4PropertyChange
     if(UserSignup.password.equals("Repeat Password") ||  txtPass4.getText().equals("Repeat Password")){
 txtPass4.setEchoChar((char)0);
       } else{
            txtPass4.setEchoChar('*'); 
       }
    }//GEN-LAST:event_txtPass4PropertyChange
