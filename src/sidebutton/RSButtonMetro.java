...
public class RSButtonMetro extends JButton implements MouseListener, MouseMotionListener {
    ...
    private Border bordeMoved = javax.swing.BorderFactory.createMatteBorder(0, 1, 0, 0, new java.awt.Color(255,255,255));
    /**
     * Color para el texts
     */
    ...
    private Font f = new Font("Segoe UI", Font.PLAIN, 14);
