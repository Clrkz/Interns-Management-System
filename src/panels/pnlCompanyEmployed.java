 ...
 * @author RojeruSan
 */
public class pnlCompanyEmployed extends javax.swing.JPanel {
...
public static int startCompList = 0,endCompList = 20;
  public static boolean lastCompList = false;
   ...
   boolean isCourse = false; 
      //static pnlCompanyEmployed cmp = new pnlCompanyEmployed(); 
      
       static pnlCompanyEmployed cmp;
     public static void main(String[] args) {
        try {
            // The following line would throw ExceptionInInitializerError
           cmp = new pnlCompanyEmployed();
        } catch (Throwable t) {
    ...
    Home.printstudentlog = false;
	 ...
	 Home.printstatistics = false;
       ...
       jTextArea1.setEditable(false);
        ...
        CompanyListFunction();
         getDepartment();
        getCourse();jLabel33.setText("Page: "+listPage); 
...
"ORDER BY sr.dateadded DESC"; 
        ...
        String query = "SELECT  c_logo  FROM company_information WHERE c_information_id='"+SelectedCompany.compid+"'"; 
           ...
           JasperDesign jd = JRXmlLoader.load("src\\reports\\deployedlist.jrxml");
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1048, 520));
        ...
        pnlStudentPersonalInfo4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Deployed List", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 14), new java.awt.Color(102, 102, 102))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnlStudentPersonalInfo4, javax.swing.GroupLayout.DEFAULT_SIZE, 572, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
